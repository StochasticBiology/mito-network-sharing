...
#args = c("Output/orig-1.xml-amlist.csv-0-0-rna-results-frame.txt", "0")

input.fname = args[1];
m = as.numeric(args[2]);
output.fname = paste(args[1], ".traces.png", sep="")
...
#  scale_colour_manual(values=cbPalette) +
  xlab("Proportion of exchange events") + ylab("Bingo score") + labs(colour = "Network", fill="Network") +
  theme_classic() +
